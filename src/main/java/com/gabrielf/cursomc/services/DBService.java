...
import com.gabrielf.cursomc.domain.Pagamento;
import com.gabrielf.cursomc.domain.PagamentoComBoleto;
import com.gabrielf.cursomc.domain.PagamentoComCartao;
import com.gabrielf.cursomc.domain.Pedido;
import com.gabrielf.cursomc.domain.Produto;
...
import com.gabrielf.cursomc.repository.CidadeRepository;
...
import com.gabrielf.cursomc.repository.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva","testflamenbaum@gmail.com","36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Gabriel Flamenbaum","flamenbaum.dev@gmail.com","65900242005", TipoCliente.PESSOAFISICA, pe.encode("456"));
		cli2.getTelefones().addAll(Arrays.asList("225636623","80938393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Treza", "505", "Apto 901", "Santa Efigenia", "44677012", cli2, c2);
